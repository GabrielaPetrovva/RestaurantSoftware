...
![Табло на мениджъра](assets/screenshots/manager-dasboard-finance.png)
...
### QR
![Генериране на QR код](assets/screenshots/QR.png)

### Статистики
![Касова бележка на поръчка](assets/screenshots/oredr-waiter.png)
