...
### 5.1 Използвани услуги
- **Firestore** – основна база данни  
- **Firebase Auth** – служителски акаунти  
- **Cloud Functions** – бизнес логика и обработка  
- **Firebase Storage** – PDF сметки  
- **Security Rules** – контрол на достъп  
- **Realtime listeners** – live синхронизация  

### 5.2 Основни Backend функции
- Създаване и редактиране на поръчки  
- Обновяване на статуси в реално време  
- Управление на меню, маси и служители  
- Генериране на PDF сметки  
- Прогнози чрез AI модул  
- Конвертиране на клиентски `cart` → `order`  
...
### 5.4 Структура на базата данни (Firestore)
